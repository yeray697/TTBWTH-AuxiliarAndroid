...
public class Login_Application extends Application {
    ...
    public void onCreate() {
        ...
        cal.set(Calendar.MONTH, Calendar.JANUARY);
        cal.set(Calendar.DAY_OF_MONTH, 5);
        New noticia4 = new New(1,"Noticia 1","Cuerpo de la noticia 1", cal.getTime(),"http://jimenezsanjuan.es/wp-content/uploads/2015/01/icono-lupa.png");
        cal.set(Calendar.YEAR, 2015);
        cal.set(Calendar.MONTH, Calendar.OCTOBER);
        cal.set(Calendar.DAY_OF_MONTH, 5);
        New noticia5 = new New(2,"Noticia 2","Cuerpo de la noticia 2", cal.getTime(),"https://classicgrandtour.files.wordpress.com/2012/10/ojo-icono.png?w=75");
        cal.set(Calendar.YEAR, 2014);
        cal.set(Calendar.MONTH, Calendar.FEBRUARY);
        cal.set(Calendar.DAY_OF_MONTH, 20);
        New noticia6 = new New(3,"Noticia 3","Cuerpo de la noticia 3", cal.getTime(),"https://cdn1.talenteca.com/assets/trucha-2.0.14/images/sesion/icono-whatsapp.png");
        news.add(noticia4);
        news.add(noticia5);
        news.add(noticia6);
        cal = Calendar.getInstance();
        ...
        cal.set(Calendar.MONTH, Calendar.JANUARY);
        cal.set(Calendar.DAY_OF_MONTH, 5);
        New noticia7 = new New(1,"Noticia 1","Cuerpo de la noticia 1", cal.getTime(),"http://jimenezsanjuan.es/wp-content/uploads/2015/01/icono-lupa.png");
        cal.set(Calendar.YEAR, 2015);
        cal.set(Calendar.MONTH, Calendar.OCTOBER);
        cal.set(Calendar.DAY_OF_MONTH, 5);
        New noticia8 = new New(2,"Noticia 2","Cuerpo de la noticia 2", cal.getTime(),"https://classicgrandtour.files.wordpress.com/2012/10/ojo-icono.png?w=75");
        cal.set(Calendar.YEAR, 2014);
        cal.set(Calendar.MONTH, Calendar.FEBRUARY);
        cal.set(Calendar.DAY_OF_MONTH, 20);
        New noticia9 = new New(3,"Noticia 3","Cuerpo de la noticia 3", cal.getTime(),"https://cdn1.talenteca.com/assets/trucha-2.0.14/images/sesion/icono-whatsapp.png");
        news.add(noticia7);
        news.add(noticia8);
        news.add(noticia9);
